...
/**
 * This model contains all the ImpactContentHistory data of the SoMeR.
...
public class ImpactContentHistory extends Model {
    ...
    // List to collect all impactContentHistory objects to render them on the history subpage.
